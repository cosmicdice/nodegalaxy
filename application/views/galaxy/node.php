                                ...
                                function print_node($node){
                                    ...
                                    echo('<div class ="node" id = "n'.$node->id.'">');
                                        echo('<div class = "node_title">
                                            ...
                                            <a title="This node" href="'.h(site_url('galaxy/node/'.$node->id)).'">'.h($node->title).'</a>
                                            ('.$subnodes.')</div>');
                            ...
                            <script language="Javascript">
                                ...
                                function reply_form(id_node) {
                                    ...
                                    str += '<textarea class = "text-input"></textarea> <br/>';
                                    str += '<input class = "link-input" type="text" name="title"><br/>';
                                    str += '';
                                    str += '';
                                    str += '';
                                    str += '';
